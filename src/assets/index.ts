const Images = {
  ...
  termsAcceptedIcon: require('./terms-accepted.png'),
  homeIcon: require('./home-icon.png'),
  connectionsIcon: require('./connections-icon.png'),
  ...
  importIcon: require('./import.png'),
  initializeIcon: require('./initialize.png'),
  walletInitializedIcon: require('./walletinitialized.png'),
